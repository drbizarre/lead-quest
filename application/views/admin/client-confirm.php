...
<!-- page title -->
    <div class="page-main-title">
        ...
        <div class="leaft-title"><h1>Eliminar - <span>Cliente</span></h1></div>
        <span class="reght-pagenation"><a href="<?php echo site_url(); ?>">Eliminar</a> <i>/ </i> clientes</span>
            ...
            <div class="table-style">
                ...
                <table class="table-list">
                    <tbody>
                        ...
                        <tr>
                            <td colspan="2"><a class="button black small" href="<?php echo site_url("clients/confirm/".$user->id); ?>">Si, deseo eliminar este usuario. </a></td>
                        </tr>                                                                                                           
                    </tbody>
                </table>
            </div>
