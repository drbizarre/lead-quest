...
<!-- page title -->
    <div class="page-main-title">
        ...
        <div class="leaft-title"><h1>Dashboard - <span>Packages</span></h1></div>
        <span class="reght-pagenation"><a href="<?php echo site_url(); ?>">Dashboard</a> <i>/ </i> Packages</span>
            ...
            <div class="table-style">
                ...
                <h3>Shipping Options</h3>
                 ...
                 if (!empty($rates)) {
                    ...
                    foreach ($rates as $servicio => $envios) {
                        echo "<h4>".$servicio."</h4>";
                        foreach ($envios as $envio => $precio) {
                            if (!empty($precio)) {
                                echo "<input type=\"radio\" name=\"".$servicio."[]\"><strong>".$precio."</strong>"." ".$envio."<br />";
                            }
                        }
                    }
                 }
