...
class CI_Email {
	...
	var	$smtp_host		= "mail.whynot.mx";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "oscar.quintero@whynot.mx";		// SMTP Username
	var	$smtp_pass		= "multiply";		// SMTP Password
